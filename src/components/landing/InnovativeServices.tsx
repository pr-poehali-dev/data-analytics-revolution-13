...
const services = [
  {
    ...
    description:
      "Покупай и продавай внутриигровую валюту по лучшим курсам. Мгновенное зачисление, сотни игр, гарантия безопасности.",
    mockup: "social",
  },
  {
    title: "Аккаунты и персонажи",
    description:
      "Готовые прокачанные аккаунты с редкими скинами, рейтингом и достижениями. Быстрый старт без лишних усилий.",
    mockup: "google-ads",
  },
  {
    title: "Игровые предметы",
    description: "Скины, оружие, артефакты и лутбоксы из популярных игр. Проверенные продавцы и гарантия передачи.",
    mockup: "email",
  },
  {
    title: "Буст и тренировки",
    description:
      "Профессиональные игроки помогут поднять рейтинг, выполнить задание или пройти сложный контент.",
    mockup: "seo",
  },
  {
    title: "Аналитика цен",
    description:
      "Следи за изменением цен в реальном времени, получай инсайты и покупай в нужный момент по лучшей стоимости.",
    mockup: "analytics",
  },
  {
    title: "Безопасные сделки",
    description:
      "Escrow-система защищает каждую сделку. Деньги хранятся у нас до подтверждения получения товара покупателем.",
    mockup: "web-dev",
    badges: [
      { icon: <Shield className="w-4 h-4" />, text: "Escrow-защита" },
      { icon: <DollarSign className="w-4 h-4" />, text: "Без скрытых комиссий" },
      { icon: <CheckCircle className="w-4 h-4" />, text: "Возврат гарантирован" },
    ],
  },
]
  ...
  return (
    <section id="services" className="py-24 bg-black relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6">Всё для игровой торговли</h2>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Покупай, продавай и обменивай игровые ценности безопасно на одной платформе.
          </p>
        </motion.div>
